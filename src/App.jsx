...
const faq = [
  ...
  {
    keywords: ["parlez de vous", "présentez-vous", "vous décrire", "qui êtes-vous", "vous présenter", "de vous", "pouvez-vous vous presenter", "Qui êtes vous ?", "Pouvez-vous vous presenter","Présentez-vous"],
